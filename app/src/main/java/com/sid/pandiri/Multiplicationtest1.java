...
public class Multiplicationtest1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multiplicationtest1);
    ...
    public void goToNextActivity() {
        ...
        Intent intent = new Intent(this,Multiplicationtest2.class);
