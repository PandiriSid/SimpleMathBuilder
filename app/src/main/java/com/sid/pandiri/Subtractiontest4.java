...
public class Subtractiontest4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subtractiontest4);
    ...
    public void goToNextActivity() {
        ...
        Intent intent = new Intent(this,Subtractiontest5.class);
