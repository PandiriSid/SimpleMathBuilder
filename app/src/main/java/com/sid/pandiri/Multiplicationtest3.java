...
public class Multiplicationtest3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multiplicationtest3);
    ...
    public void goToNextActivity() {
        ...
        Intent intent = new Intent(this,Multiplicationtest4.class);
