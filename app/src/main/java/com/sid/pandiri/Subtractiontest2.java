...
public class Subtractiontest2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subtractiontest2);
    ...
    public void goToNextActivity() {
        ...
        Intent intent = new Intent(this,Subtractiontest3.class);
