...
import com.sid.pandiri.WrongMultiplication;

public class GuiActivity2 extends AppCompatActivity {
        ...
        try {
            search.setOnClickListener(new View.OnClickListener()   {
                public void onClick(View arg0) {
                    ...
                    Intent intent = new Intent(context,CorrectMultiplication.class);
        ...
        try {
            search1.setOnClickListener(new View.OnClickListener()   {
                public void onClick(View arg0) {
                    ...
                    Intent intent = new Intent(context,WrongMultiplication.class);
                    startActivity(intent);
