...
public class Multiplicationtest4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multiplicationtest4);
    ...
    public void goToNextActivity() {
        ...
        Intent intent = new Intent(this,Multiplicationtest5.class);
